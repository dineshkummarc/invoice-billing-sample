  ...
  <body style="background: rgb(233, 233, 233); font-family: Segoe UI light;">
    ...
    <div class="container-fluid">
      ...
      <style type="text/css">
        ...
        #order_receiver_name,#order_receiver_address{
          width: 50%;
          margin-top: 15px;
        }
        #order_no{
      ...
      <form method="post" id="invoice_form" style="margin-top: 100px;">
<!--          <?php var_dump($_REQUEST); ?>-->
                ...
                <td colspan="2">
                  <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="form-group">
                        <input name="order_receiver_address" id="order_receiver_address" class="form-control" placeholder="Enter Mobile Number"/>
                        </div>
                    </div>
                    <div class="col-md-4">
      ...
      $(document).ready(function(){
        ...
        $(document).on('click', '#add_row', function(){
          ...
          html_code += '<td><button type="button" name="remove_row" id="'+count+'" class="btn btn-danger btn-xs remove_row">Remove</button></td>';
          html_code += '</tr>';
          ...
          <table class="table table-bordered table-hover table-striped">
            <tr>
                <td colspan="2">
                  ...
                  <br />
                  <table id="invoice-item-table" class="table table-bordered table-hover table-striped" style="margin-top: 35px;">
                    <tr>
                      <th width="5%">S/N</th>
                      <th width="20%">Item Name</th>
                      <th width="10%">Quantity</th>
    ...
    <br />
      <br />
      <br />
      <table id="data-table" class="table table-bordered table-striped card table-hover" style="margin-top: 50px;padding: 10px;">
        <thead>
          <tr>
            <th>Invoice No.</th>
            <th>Invoice Date</th>
